<div class="content_view" style="margin:0 auto; max-width:500px;">
    <?php if($content['ProjectContent']['movie_type'] == 'youtube'): ?>
        <iframe class="movie" src="//www.youtube.com/embed/<?php echo h($content['ProjectContent']['movie_code']) ?>"
                frameborder="0" allowfullscreen></iframe>
    <?php else: ?>
        <iframe class="movie"
                src="//player.vimeo.com/video/<?php echo h($content['ProjectContent']['movie_code']) ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=9c1e1e"
...
<div class="content_edit_form clearfix" style="display: none;">
    ...
    <div class="form-group" id="movie_btns">
        <button type="button"
                onclick="edit_movie($(this), '<?php echo $this->Html->url('/admin/admin_project_contents/movie_edit') ?>');"
