<div class="content_view" style="margin:0 auto; max-width:500px; text-align:center;">
    <?php if($this->Label->link($content['ProjectContent']['img'])){
        echo $this->Label->image($content['ProjectContent']['img'], array(
                'class' => 'img-responsive', 'style' => 'margin:0 auto;'
        ));
    } ?>
    <p class="img_caption">
        <?php echo h($content['ProjectContent']['img_caption']) ?>
    </p>
</div>
...
<div class="content_edit_form clearfix" style="display: none;">
    ...
    <div class="form-group">
        <?php echo $this->Form->input('img', array(
                ...
                'onchange' => "client_resize($(this), event, 750, null, 'preview_img".$content['ProjectContent']['id']
                              ."', 'img');"
        )); ?>
        <div id="preview_img<?php echo h($content['ProjectContent']['id']) ?>"
    ...
    <div class="form-group">
        <?php echo $this->Form->input('img_caption', array(
                ...
                'value' => $content['ProjectContent']['img_caption']
        )); ?>
    </div>

    <div class="form-group" id="movie_btns">
        <button type="button"
                onclick="edit_img($(this), event, '<?php echo $this->Html->url('/admin/admin_project_contents/img_edit') ?>');"
