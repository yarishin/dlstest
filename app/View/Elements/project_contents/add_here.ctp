<div onmouseover="display_add_here($(this));" onmouseout="remove_add_here($(this));"
    ...
    <div class="add_here none">
        <button type="button" onclick="display_add_here_menu($(this));" class="btn btn btn-info btn-block add_here_btn">
            ここに追加
        </button>
    </div>
    <div class="add_here_menu none" style="background-color:#eee; padding:10px;">
        <div class="btn-group">
            <button type="button" onclick="new_text($(this));" class="btn btn-default">
                <sapan class="el-icon-pencil"></sapan>
            </button>

            <button type="button" onClick="new_img($(this));" class="btn btn-default">
                <span class="el-icon-picture"></span>
            </button>

            <button type="button" onclick="new_movie($(this));" class="btn btn-default">
