...
class BindableTestCase extends CakeTestCase
{
    ...
    public $fixtures = array(
            'plugin.filebinder.attachment', 'plugin.filebinder.filebinder_post'
    );
    ...
    public function testFind()
    {
        ...
        $this->FilebinderPost->bindFields = array(
                array(
                        'field' => 'logo', 'tmpPath' => CACHE, 'filePath' => $filePath,
                ),
        );
        $query                            = array();
        ...
        $expected                         = array(
                'id' => 1, 'title' => 'Title', 'body' => 'Filebinder.Bindable Test', 'created' => '2011-08-23 17:44:58',
                'modified' => '2011-08-23 12:05:02', 'logo' => array(
                        'id' => 100, 'model' => 'FilebinderPost', 'model_id' => 1, 'field_name' => 'logo',
                        'file_name' => 'logo.png', 'file_content_type' => 'image/png', 'file_size' => '771311',
                        'created' => '2011-08-22 19:29:32', 'modified' => '2011-08-22 19:29:32',
                        'file_path' => $filePath.'FilebinderPost/1/logo/logo.png', 'bindedModel' => 'Attachment'
                ),
        );
    ...
    public function testFindNoAttachment()
    {
        ...
        $result                           = $this->FilebinderPost->find('first', $query);
        $expected                         = array(
                'id' => 401, 'title' => 'No Attachment', 'body' => 'Filebinder.Bindable Test',
                'created' => '2011-08-23 17:44:58', 'modified' => '2011-08-23 12:05:02', 'logo' => null
                // Set null
        );
        $this->assertEqual($result['FilebinderPost'], $expected);
    }
        ...
        $data                             = array(
                'FilebinderPost' => array(
                        'title' => 'Title', 'logo' => array(
                                'model' => 'FilebinderPost', 'field_name' => 'logo', 'file_name' => 'logo.png',
                                'file_content_type' => 'image/png', 'file_size' => 1395, 'tmp_bind_path' => $tmpPath
                        )
                )
        );
    ...
    public function testSaveS3()
    {
        ...
        $settings['storage'] = array(
                BindableBehavior::STORAGE_DB, BindableBehavior::STORAGE_S3
        );
        $this->FilebinderPost->setSettings($settings);
        // set test.png
        $this->_setTestFile($tmpPath);
        ...
        $this->FilebinderPost->bindFields = array(
                array(
                        'field' => 'logo', 'tmpPath' => CACHE, 'filePath' => $filePath, 'bucket' => AWS_S3_BUCKET,
        ...
        $this->assertIdentical(file_get_contents($result['FilebinderPost']['logo']['file_path']), file_get_contents('http://'
                                                                                                                    .AWS_S3_BUCKET
                                                                                                                    .'.s3.amazonaws.com/'
                                                                                                                    .$urlPrefix
                                                                                                                    .'FilebinderPost/'
                                                                                                                    .$result['FilebinderPost']['id']
                                                                                                                    .'/'
                                                                                                                    .'logo/'
                                                                                                                    .$result['FilebinderPost']['logo']['file_name']));
        // rm file
        if(file_exists($result['FilebinderPost']['logo']['file_path'])){
            unlink($result['FilebinderPost']['logo']['file_path']);
        }
    ...
    public function testSaveS3WithUrlPrefix()
    {
        ...
        $this->FilebinderPost->bindFields = array(
                array(
                        'field' => 'logo', 'tmpPath' => CACHE, 'filePath' => $filePath, 'urlPrefix' => $urlPrefix,
                        'bucket' => AWS_S3_BUCKET, 'acl' => AmazonS3::ACL_PUBLIC,
                ),
        );
        $data                             = array(
                'FilebinderPost' => array(
    ...
    public function testDeleteS3()
    {
        ...
        $urlPrefix                        = Configure::read('Filebinder.S3.urlPrefix');
        $this->assertTrue(file_exists($result['FilebinderPost']['logo']['file_path']));
        $this->assertIdentical(file_get_contents('http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/'.$urlPrefix
                                                 .'FilebinderPost/'.$result['FilebinderPost']['id'].'/'.'logo/'
                                                 .$result['FilebinderPost']['logo']['file_name']), file_get_contents($result['FilebinderPost']['logo']['file_path']));
        $this->FilebinderPost->delete($id);
        $this->assertFalse(file_exists($result['FilebinderPost']['logo']['file_path']));
        $this->assertFalse(@file_get_contents('http://'.AWS_S3_BUCKET.'.s3.amazonaws.com/'.$urlPrefix.'FilebinderPost/'
                                              .$result['FilebinderPost']['id'].'/'.'logo/'
                                              .$result['FilebinderPost']['logo']['file_name']));
    }
    ...
    public function testDelete_bindedFileOnly()
    {
        ...
        $data                             = array(
                'FilebinderPost' => array(
                        'id' => $id, 'title' => 'Title', 'logo' => null, 'delete_logo' => '1',
                )
        );
    ...
    public function testNotDelete_bindedFile()
    {
        ...
        $data                             = array(
                'FilebinderPost' => array(
                        'id' => $id, 'title' => 'Title', 'logo' => null, 'delete_logo' => '0',
                )
        );
        $this->FilebinderPost->save($data);
        $this->assertIdentical(file_exists($result['FilebinderPost']['logo']['file_path']), true);
    ...
    public function testUpdateFile()
    {
        ...
        $data                             = array(
                'FilebinderPost' => array(
                        'id' => $id, 'title' => 'Title', 'logo' => array(
                                'model' => 'FilebinderPost', 'field_name' => 'logo', 'file_name' => 'logo2.png',
                                // file_name:logo2.png
                                'file_content_type' => 'image/png', 'file_size' => 1395, 'tmp_bind_path' => $tmpPath2
                        )
                )
        );
    ...
    {
        $data   = array('file' => array('file_size' => 1 * 1024 * 1024),);
